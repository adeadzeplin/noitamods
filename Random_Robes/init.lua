...
ModDevGenerateSpriteUVsForDirectory( "mods/Random_robes/files/fire" ) 
ModDevGenerateSpriteUVsForDirectory( "mods/Random_robes/files/slime" ) 
ModDevGenerateSpriteUVsForDirectory( "mods/Random_robes/files/summoner" ) 
ModDevGenerateSpriteUVsForDirectory( "mods/Random_robes/files/thunder" ) 